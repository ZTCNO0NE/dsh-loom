...
const DEFAULT_MAX_PARALLEL_TOOL_CALLS = 1;
//#endregion
...
function resolveMaxParallelToolCalls(value) {
	const maxParallelToolCalls = value ?? 1;
...
const AGENT_LOOP_SETTINGS_SCHEMA = z.object({ maxParallelToolCalls: z.number().step(1).min(1).default(1) });
...
var AgentLoop = class extends Service {
	...
	static Config = z.object({
		maxParallelToolCalls: z.number().step(1).min(1).default(1),
