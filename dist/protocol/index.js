...
export const paths = {
    ...
    builderRun: (root, sessionId, patchId) => join(patchDir(root, sessionId, patchId), 'builder-run.json'),
    builderResume: (root, sessionId) => join(workspaceDir(root, sessionId), 'builder', 'resume.json'),
