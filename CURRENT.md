...
## 2026-08-21 回滚后旧“待重启”文案冲突（代码已修，待 Windows 换包复测）
...
- 验证：定向 13/13、全量 **262/262**、`npm run check`、`npm run build`、`git diff --check` 通过。SSH ControlMaster 在传 Windows 测试包前失效，因此尚未宣称 Windows 新包复测通过，亦未发布新版本。
