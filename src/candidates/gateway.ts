...
import { CandidateImporter, CandidateRegistry, type CandidateAcquisitionRequest, type CandidateManifest } from './index.js'
...
export class LoopCandidateGateway {
  ...
  private normalize(value: CandidateAcquisitionRequest): CandidateAcquisitionRequest {
    ...
    if (!source || typeof source.uri !== 'string' || typeof source.ref !== 'string') throw new Error('loop candidate gateway: candidate source.uri/ref required')
