...
![两种理解层面：配置态 vs 治理态](../figures/fig-mode-compare.png)
...
在 dsh 生态里同理：官方插件机制（bundle / insert）解决"怎么装"，plugin-registry 控制台是人工管理安装态，静态 skills 目录靠手动维护——dsh-loom 补的是它们都没有的那层：**装什么、什么时候装、装错了怎么办，由治理回路决定。**
